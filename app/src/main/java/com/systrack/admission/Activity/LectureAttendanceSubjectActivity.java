...
public class LectureAttendanceSubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_search_by_name.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                Call<StudentAttendanceInformationPojo> call = apiInterface.FillSubjectListLectureAttendance(entity_id, branch_id, currentAcademicYear, BatchId,
                        SectionId,CourseId,Medium,EMPLOYEEID,ROLEID,edt_search_by_name.getText().toString());
                call.enqueue(new Callback<StudentAttendanceInformationPojo>() {
                    ...
                    public void onResponse(Call<StudentAttendanceInformationPojo> call, Response<StudentAttendanceInformationPojo> response) {
                        ...
                        if (StatusCode.equals("200")) {
                            ...
                            adapter = new StudentAttendanceSubAdapter(LectureAttendanceSubjectActivity.this, array_course_spinner);
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(LectureAttendanceSubjectActivity.this, DisplayMsg, Toast.LENGTH_SHORT).show();
                        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                    ...
                    appController.setLectureAttendanceSubId(array_course_spinner.get(position).getSUBJECTID().toString());
                    appController.setLectureAttendanceSubName(array_course_spinner.get(position).getSUBJECTNAME());
                    finish();
//                }
            }
        });
    ...
    private void getSubjectList() {
        if(error==null) {
            ...
            if (mProgressDialog == null)
                mProgressDialog = new TransparentProgressDialog(LectureAttendanceSubjectActivity.this);
...
Log.e("PAram ",BatchId + " ** "+SectionId + " ** "+CourseId + " ** "+Medium );
            ...
            Call<StudentAttendanceInformationPojo> call = apiInterface.FillSubjectListLectureAttendance(entity_id, branch_id, currentAcademicYear, BatchId,
                    SectionId,CourseId,Medium,EMPLOYEEID,ROLEID,"");
            call.enqueue(new Callback<StudentAttendanceInformationPojo>() {
                @Override
                public void onResponse(Call<StudentAttendanceInformationPojo> call, Response<StudentAttendanceInformationPojo> response) {
                    Log.e("Response  ", new Gson().toJson(response.body()));
            ...
            Toast.makeText(LectureAttendanceSubjectActivity.this, error, Toast.LENGTH_SHORT).show();
        }
    }
