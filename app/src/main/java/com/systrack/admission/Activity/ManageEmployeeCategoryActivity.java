...
public class ManageEmployeeCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                Call<ManageEmployeeCoursePojo> call = apiInterface.FillCategoryList(entity_id,branch_id,edt_search.getText().toString());
                    ...
                    public void onResponse(Call<ManageEmployeeCoursePojo> call, Response<ManageEmployeeCoursePojo> response) {
                        ...
                        if (StatusCode.equals("200")) {
                            ...
                            for (int i = 1; i < Size; i++) {
                                ...
                                pojo.setcATEGORYID(pojoitem.getEmployeeInformation().get(i).getcATEGORYID());
                                pojo.setcATEGORYNAME(pojoitem.getEmployeeInformation().get(i).getcATEGORYNAME());


                                arrayList.add(pojo);

                            }
                            ManageEmployeeCategoryAdapter adapter = new ManageEmployeeCategoryAdapter(ManageEmployeeCategoryActivity.this, arrayList);
                            ...
                            mProgressDialog.dismiss();
                            Toast.makeText(ManageEmployeeCategoryActivity.this, DisplayMsg, Toast.LENGTH_SHORT).show();
                        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                appController.setManageEmpCategoryId(String.valueOf(arrayList.get(position).getcATEGORYID()));
                appController.setManageEmpCategoryName(arrayList.get(position).getcATEGORYNAME());
    ...
    private void getCategoryList() {
            ...
            if (mProgressDialog == null)
                mProgressDialog = new TransparentProgressDialog(ManageEmployeeCategoryActivity.this);
            ...
            Call<ManageEmployeeCoursePojo> call = apiInterface.FillCategoryList(entity_id,branch_id,"");
            call.enqueue(new Callback<ManageEmployeeCoursePojo>() {
                @Override
                public void onResponse(Call<ManageEmployeeCoursePojo> call, Response<ManageEmployeeCoursePojo> response) {
                    Log.e("Response  ", new Gson().toJson(response.body()));
