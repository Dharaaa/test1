...
public class ExamTimeAdapter extends BaseAdapter {
    ...
    public ExamTimeAdapter(Context context, ArrayList<HallArrangementStudentInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getdISPLAYEXAMTIME());
