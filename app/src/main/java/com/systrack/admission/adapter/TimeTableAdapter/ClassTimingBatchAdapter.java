...
public class ClassTimingBatchAdapter extends BaseAdapter {
    ...
    public ClassTimingBatchAdapter(Context context, ArrayList<RoomCategoryInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getbATCHNAME());
