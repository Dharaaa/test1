...
public class StudentAttendanceSubAdapter extends BaseAdapter {
    ...
    public StudentAttendanceSubAdapter(Context context, ArrayList<StudentAttendanceInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getSUBJECTNAME());
