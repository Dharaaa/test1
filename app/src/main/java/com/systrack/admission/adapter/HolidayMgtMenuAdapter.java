...
public class HolidayMgtMenuAdapter extends RecyclerView.Adapter<HolidayMgtMenuAdapter.ViewHolder> {
    ...
    public HolidayMgtMenuAdapter(Context context, String[] sliderpojo_arrayList) {
...
//        DYNAMICLABEL = String.valueOf(sharedpreferences.getString(context.getString(R.string.DYNAMICLABEL),""));
    ...
    @Override
    public HolidayMgtMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_menu_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final HolidayMgtMenuAdapter.ViewHolder viewHolder, final int i) {
...
//Log.e("DYNAMICLABELD  ",DYNAMICLABEL+"**");
        ...
        if(sliderpojo_arrayList[i].equals("National Holiday"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.HOLIDAY));
        }
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sliderpojo_arrayList[i].equals("National Holiday"))
                {
                    NationalHolidayFragment fragement = new NationalHolidayFragment();
