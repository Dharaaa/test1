...
public class LectureAttendanceAdapter extends BaseAdapter {
    ...
    public LectureAttendanceAdapter(Context context, ArrayList<LectureAttendanceInformation> arrayList){
