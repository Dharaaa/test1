...
public class CurrentLeaveApplicationAdapter extends BaseAdapter {
...
FontAwesomeTextview view_leave_application;
    public CurrentLeaveApplicationAdapter(Context context, ArrayList<LeaveApplicationInformation> arrayList){
    ...
    public View getView(final int i, View convertview, ViewGroup viewGroup) {
        ...
        final View view = inflater.inflate(R.layout.item_current_leave_application,viewGroup,false);
        ...
        start_date.setText(arrayList.get(i).getLEAVESTARTDATE());
        end_date.setText(arrayList.get(i).getLEAVEENDDATE());
