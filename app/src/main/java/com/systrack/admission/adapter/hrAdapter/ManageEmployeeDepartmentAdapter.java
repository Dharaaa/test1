...
public class ManageEmployeeDepartmentAdapter extends BaseAdapter {
    ...
    public ManageEmployeeDepartmentAdapter(Context context, ArrayList<ManageEmployeeCourseInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        spinner_item_academic.setText(arrayList.get(i).getdEPARTMENTNAME());
