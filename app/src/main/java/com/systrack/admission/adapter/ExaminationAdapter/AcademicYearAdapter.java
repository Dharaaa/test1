...
public class AcademicYearAdapter extends BaseAdapter {
    ...
    public AcademicYearAdapter(Context context, ArrayList<AcademicyearInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getCOMBINEYEAR());
