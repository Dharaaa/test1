...
public class LeaveYearAdapter extends BaseAdapter {
    ...
    public LeaveYearAdapter(Context context, ArrayList<LeaveAssignInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getDURATIONNAME());
