...
import com.systrack.admission.fragment.LeaveManagement.EmpLeaveApplicationTabFragment;
...
public class EmpLeaveMgtMenuAdapter extends RecyclerView.Adapter<EmpLeaveMgtMenuAdapter.ViewHolder> {
    ...
    public EmpLeaveMgtMenuAdapter(Context context, String[] sliderpojo_arrayList) {
...
//        DYNAMICLABEL = String.valueOf(sharedpreferences.getString(context.getString(R.string.DYNAMICLABEL),""));
    ...
    @Override
    public EmpLeaveMgtMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_menu_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final EmpLeaveMgtMenuAdapter.ViewHolder viewHolder, final int i) {
...
//Log.e("DYNAMICLABELD  ",DYNAMICLABEL+"**");
        ...
        if(sliderpojo_arrayList[i].equals("Leave Application"))
        {
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sliderpojo_arrayList[i].equals("Leave Application"))
                {
                    EmpLeaveApplicationTabFragment fragement = new EmpLeaveApplicationTabFragment();
