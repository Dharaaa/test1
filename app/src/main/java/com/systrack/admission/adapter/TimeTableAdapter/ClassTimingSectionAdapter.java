...
public class ClassTimingSectionAdapter extends BaseAdapter {
    ...
    public ClassTimingSectionAdapter(Context context, ArrayList<SectionInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getSTREAMTYPE());
