...
public class ManageEmployeeMediumAdapter extends BaseAdapter {
    ...
    public ManageEmployeeMediumAdapter(Context context, ArrayList<ManageEmployeeCourseInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        spinner_item_academic.setText(arrayList.get(i).getMEDIUM());
