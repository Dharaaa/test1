...
import com.systrack.admission.fragment.CourseManagement.BatchFragment;
import com.systrack.admission.fragment.CourseManagement.ClassDivisionFragment;
import com.systrack.admission.fragment.CourseManagement.SubjectAllocationFragment;
...
public class CourseMgtMenuAdapter extends RecyclerView.Adapter<CourseMgtMenuAdapter.ViewHolder> {
    ...
    public CourseMgtMenuAdapter(Context context, String[] sliderpojo_arrayList) {
...
//        DYNAMICLABEL = String.valueOf(sharedpreferences.getString(context.getString(R.string.DYNAMICLABEL),""));
    ...
    @Override
    public CourseMgtMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_menu_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CourseMgtMenuAdapter.ViewHolder viewHolder, final int i) {
...
//Log.e("DYNAMICLABELD  ",DYNAMICLABEL+"**");
        ...
        if(sliderpojo_arrayList[i].equals("Batch"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.COURSE_BATCH));
        }else if(sliderpojo_arrayList[i].equals("Teacher Allocation"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.COURSE_SECTION_ALLOW));

        }else if(sliderpojo_arrayList[i].equals("Subject Allocation"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.COURSE_SUBJECT_ALLOW));

        }else if(sliderpojo_arrayList[i].equals("Class Division"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.COURSE_CLASS_DIVISION));
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sliderpojo_arrayList[i].equals("Batch"))
                {
                    BatchFragment fragement = new BatchFragment();
                ...
                {
                    ClassDivisionFragment fragement = new ClassDivisionFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
                ...
                {
                    TeacherAllocationFragment fragement = new TeacherAllocationFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
                ...
                {
                    SubjectAllocationFragment fragement = new SubjectAllocationFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
                }
