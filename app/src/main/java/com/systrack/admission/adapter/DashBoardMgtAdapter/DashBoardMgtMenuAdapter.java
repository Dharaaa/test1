...
public class DashBoardMgtMenuAdapter extends RecyclerView.Adapter<DashBoardMgtMenuAdapter.ViewHolder> {
    ...
    public DashBoardMgtMenuAdapter(Context context, String[] sliderpojo_arrayList) {
...
//        DYNAMICLABEL = String.valueOf(sharedpreferences.getString(context.getString(R.string.DYNAMICLABEL),""));
    ...
    @Override
    public DashBoardMgtMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_menu_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final DashBoardMgtMenuAdapter.ViewHolder viewHolder, final int i) {
...
//Log.e("DYNAMICLABELD  ",DYNAMICLABEL+"**");
        ...
        if(sliderpojo_arrayList[i].equals("Message of the day"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.DASHBOARD_MESSAGE));
        }else if(sliderpojo_arrayList[i].equals("Notice"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.DASHBOARD_NOTICE));
        }
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sliderpojo_arrayList[i].equals("Message of the day"))
                {
                    MessageOfDayFragment fragement = new MessageOfDayFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
//                    Toast.makeText(context, "Message", Toast.LENGTH_SHORT).show();
                }if(sliderpojo_arrayList[i].equals("Notice"))
                {
