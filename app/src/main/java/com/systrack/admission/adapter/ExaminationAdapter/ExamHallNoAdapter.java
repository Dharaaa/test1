...
public class ExamHallNoAdapter extends BaseAdapter {
    ...
    public ExamHallNoAdapter(Context context, ArrayList<HallArrangementStudentInformation> arrayList){
    ...
    public View getView(int i, View convertview, ViewGroup viewGroup) {
        ...
        name.setText(arrayList.get(i).getrOOMMASTERNAME());
