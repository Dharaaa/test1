...
import com.systrack.admission.fragment.Dashboard_Management.MessageOfDayFragment;
import com.systrack.admission.fragment.Dashboard_Management.NoticeFragment;
import com.systrack.admission.fragment.TelephoneDiary.EmployeeContactFragment;
import com.systrack.admission.helpers.FontAwesomeTextview;

public class TelephoneDiaryMenuAdapter extends RecyclerView.Adapter<TelephoneDiaryMenuAdapter.ViewHolder> {
    ...
    public TelephoneDiaryMenuAdapter(Context context, String[] sliderpojo_arrayList) {
...
//        DYNAMICLABEL = String.valueOf(sharedpreferences.getString(context.getString(R.string.DYNAMICLABEL),""));
    ...
    @Override
    public TelephoneDiaryMenuAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_menu_items, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TelephoneDiaryMenuAdapter.ViewHolder viewHolder, final int i) {
...
//Log.e("DYNAMICLABELD  ",DYNAMICLABEL+"**");
        ...
        if(sliderpojo_arrayList[i].equals("Employee Contact"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.EMPLOYEE_CONTACT));
        }else if(sliderpojo_arrayList[i].equals("Student Contact"))
        {
            viewHolder.icon_nav.setText(context.getResources().getString(R.string.STUDENT_CONTACT));
        }
        ...
        viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(sliderpojo_arrayList[i].equals("Employee Contact"))
                {
                    EmployeeContactFragment fragement = new EmployeeContactFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
                    Toast.makeText(context, "Emp", Toast.LENGTH_SHORT).show();
                }if(sliderpojo_arrayList[i].equals("Student Contact"))
                {
                    NoticeFragment fragement = new NoticeFragment();
                    FragmentTransaction transaction = ((AppCompatActivity)context).getSupportFragmentManager().beginTransaction();
                    transaction.replace(R.id.frame, fragement);
                    transaction.commit();
